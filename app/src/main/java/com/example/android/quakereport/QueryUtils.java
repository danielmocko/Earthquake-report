    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i =0; i<jsonArray.length();i++){
                ...
                JSONObject propertyJSONObject = (JSONObject) featuresJSONObject.opt("properties");

                double magnitude = propertyJSONObject.optDouble("mag");
                String place= propertyJSONObject.optString("place");
                long timeInMIliseconds = propertyJSONObject.optLong("time");

                earthquakes.add(new Earthquake(magnitude,place,timeInMIliseconds));
            }
